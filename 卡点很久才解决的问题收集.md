...
function tags(strings, personExp) {
    let str0 = strings[0]; // "Hello,"
    let str1 = strings[1]; // "!"
    let name = personExp.name;
    let age = personExp.age;
    return `${str0}${name}${str1}`;
}

// 这里 直接把tags函数调用了 顺序传参
console.log(tags`Hello, ${person}!`);  // 输出: Hello, Alice!
```



多主题 多样式方案 看css/theme/index.md


pnpm 多包管理 看 pnpm/index.md
...
function openWin(){
	...
	myWindow.document.write("<p>这是我的窗口</p><script>window.opener = null<\/script>");
	myWindow.focus();
